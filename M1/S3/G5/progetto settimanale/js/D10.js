...
let stringa = 'Questa stringa 4 non contiene 7 numeri 9'
...
let compleanno = new Date('2024-02-09')
...
console.log(deleteProp(animali, 'volatili'))
...
/* ESERCIZIO 16
  ...
  che ritorna la somma di tutti gli anni in cui sono stati prodotti i film contenuti nell'array "movies" fornito.
*/
function sumAllTheYears(){
  return movies.reduce((totalYear, movies) => totalYear + parseInt(movies.Year), 0 )
}
...
function selectTagTd(){
  let td = document.getElementByTag('td')
}
